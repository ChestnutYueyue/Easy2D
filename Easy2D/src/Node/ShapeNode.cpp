...
easy2d::ShapeNode::ShapeNode(Shape::LineType, Point begin, Point end,
                             DrawingStyle style)
    : ShapeNode(gcnew Shape(Shape::Line, begin, end), style) {}

easy2d::ShapeNode::ShapeNode(Shape::RectType, const Size &size,
                             DrawingStyle style)
    : ShapeNode(gcnew Shape(Shape::Rect, Rect(Point(), size)), style) {}

easy2d::ShapeNode::ShapeNode(Shape::RoundedRectType, const Size &size,
                             const Vector2 &radius, DrawingStyle style)
    : ShapeNode(gcnew Shape(Shape::RoundedRect, Rect(Point(), size), radius),
                style) {}

easy2d::ShapeNode::ShapeNode(Shape::CircleType, float radius,
                             DrawingStyle style)
    : ShapeNode(gcnew Shape(Shape::Circle, Point(radius, radius), radius),
                style) {}

easy2d::ShapeNode::ShapeNode(Shape::EllipseType, const Vector2 &radius,
                             DrawingStyle style)
    : ShapeNode(gcnew Shape(Shape::Ellipse, radius, radius), style) {}

easy2d::ShapeNode::ShapeNode(Shape::PolygonType,
                             std::initializer_list<Point> vertices,
                             DrawingStyle style)
    : ShapeNode(gcnew Shape(Shape::Polygon, vertices), style) {}

easy2d::ShapeNode::ShapeNode(Shape::PolygonType, const Point *vertices,
                             int count, DrawingStyle style)
    : ShapeNode(gcnew Shape(Shape::Polygon, vertices, count), style) {}

easy2d::ShapeNode::ShapeNode(Shape *shape, DrawingStyle style)
    : _shape(nullptr), _style(style), _bounds() {
  setShape(shape);
}

easy2d::ShapeNode::~ShapeNode() { GC::release(_shape); }

easy2d::Shape *easy2d::ShapeNode::getShape() const { return _shape; }
...
void easy2d::ShapeNode::setDrawingStyle(DrawingStyle style) { _style = style; }
...
void easy2d::ShapeNode::onRender() {
  ...
  if (_style.mode == DrawingStyle::Mode::Fill ||
    ...
    Renderer::getRenderTarget()->DrawGeometry(_shape->_geo, pBrush,
                                              _style.strokeWidth, strokeStyle);
  }
...
float easy2d::ShapeNode::getStrokeWidth() const { return _style.strokeWidth; }
...
easy2d::Rect easy2d::ShapeNode::getBounds() const { return _bounds; }
