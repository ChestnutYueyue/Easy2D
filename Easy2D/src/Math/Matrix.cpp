...
easy2d::Matrix32::Matrix32(float _11, float _12, float _21, float _22,
                           float _31, float _32)
...
void easy2d::Matrix32::translate(const Vector2 &v) { translate(v.x, v.y); }
...
bool easy2d::Matrix32::isIdentity() const {
  return _11 == 1.f && _12 == 0.f && _21 == 0.f && _22 == 1.f && _31 == 0.f &&
         _32 == 0.f;
}

bool easy2d::Matrix32::isInvertible() const { return 0 != determinant(); }
...
easy2d::Matrix32 easy2d::Matrix32::translation(float x, float y) {
  return easy2d::Matrix32(1.f, 0.f, 0.f, 1.f, x, y);
}

easy2d::Matrix32 easy2d::Matrix32::scaling(float x, float y,
                                           const Point &center) {
  return easy2d::Matrix32(x, 0.f, 0.f, y, center.x - x * center.x,
                          center.y - y * center.y);
}
...
easy2d::Matrix32 easy2d::Matrix32::rotation(float angle, const Point &center) {
  ...
  return easy2d::Matrix32(c, s, -s, c, center.x * (1 - c) + center.y * s,
                          center.y * (1 - c) - center.x * s);
}

easy2d::Matrix32 easy2d::Matrix32::skewing(float angle_x, float angle_y,
                                           const Point &center) {
  float tx = math::Tan(angle_x);
  float ty = math::Tan(angle_y);
  return easy2d::Matrix32(1.f, -ty, -tx, 1.f, center.y * tx, center.x * ty);
}
...
easy2d::Matrix32 easy2d::Matrix32::invert(Matrix32 const &matrix) {
  ...
  return easy2d::Matrix32(
      det * matrix._22, -det * matrix._12, -det * matrix._21, det * matrix._11,
